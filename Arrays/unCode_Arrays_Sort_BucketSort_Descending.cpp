// Program for Bucket Sort (in Descending order)
...
// Function to perform Bucket Sort in descending order
void bucketSortDescending(vector<int>& arr)
{
    ...
    // Concatenate the sorted buckets in reverse order to get descending order
    int index = 0;
